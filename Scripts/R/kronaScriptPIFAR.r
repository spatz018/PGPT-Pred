...
ForKronaPlot <- function(TakeInputFile,TakeOutFileName) {
	plot_krona(parsing_to_require_format(TakeInputFile),TakeOutFileName,"Name",trim=T)
...
ForKronaPlot(args$InputFile,args$OutputHTMLFile)